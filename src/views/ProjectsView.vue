...
import { ref } from 'vue';
import transittrackImage from '@/assets/Portfolio/transittrack.png';
import eventwiseImage from '@/assets/Portfolio/eventwise.png';
import pokusImage from '@/assets/Portfolio/pokus.png';
import scholarAttendanceImage from '@/assets/Portfolio/scholar-attendance.png';
import khenkentImage from '@/assets/Portfolio/business_barber.png';
// Add state for modal
